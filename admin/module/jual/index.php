                ...
                ?>
								...
								<tr>
									...
									<td>
										...
										<a href="fungsi/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan'];?>&brg=<?php echo $isi['id_barang'];?>
											&jml=<?php echo $isi['jumlah']; ?>"  class="btn btn-danger" onclick="return confirm('yakin?')"><i class="fa fa-times"></i>
										</a>
									</td>
								</tr>
					...
					<div id="kasirnya">
						<table class="table table-stripped">
							...
							<tr>
								<td>Kembali</td>
								<td><input type="text" class="form-control" value="<?php echo isset($hitung) ? number_format($hitung, 0, ',', '.') : '0';?>" readonly></td>
								<td></td>
								<td>
									<a href="print.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?>
									&bayar=<?php echo isset($bayar) ? $bayar : '0';?>&kembali=<?php echo isset($hitung) ? $hitung : '0';?>" target="_blank">
...
<script>
<?php
if(isset($_SESSION['success_message']) || isset($_SESSION['error_message']) || isset($_GET['remove'])) {
